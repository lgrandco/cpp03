...
void ClapTrap::set_hit_points(size_t hit_points) { this->hit_points = hit_points; }

void ClapTrap::set_energy_points(size_t energy_points) { this->energy_points = energy_points; }

void ClapTrap::set_attack_damage(size_t attack_damage) { this->attack_damage = attack_damage; }
